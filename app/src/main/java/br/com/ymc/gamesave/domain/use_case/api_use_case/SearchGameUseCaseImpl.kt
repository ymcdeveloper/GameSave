...
class SearchGameUseCaseImpl @Inject constructor(private val repository: GameRepository) : SearchGameUseCase
{
    override suspend operator fun invoke(searchQuery: String): Flow<Resource<List<Game>>>
    {
        return flow {
